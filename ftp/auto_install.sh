...
#此脚本为自动安装vsftpd
#
#运行此脚本首先运行   sh auto_install_vsftp.sh install
#         再次运行  sh auto_install_vsftp.sh useradd user password
#
##########################
...
virtual_user_home=/data/ftproot    #ftp根目录位置
guest_username=ftp    #指定ftp权限账号
