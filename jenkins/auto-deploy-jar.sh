...
JAR_PID=`ps -aux | grep 'test.yaml-expro-choose.jar'|grep -v grep|awk '{print $2}'`
...
jarFile="/home/jenkins/testTomcat/test.yaml-expro-choose.jar"
...
echo "成功启动Jar.test.yaml-expro-choose.jar"
